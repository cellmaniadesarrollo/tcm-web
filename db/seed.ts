...
export default async function seed() {
	...
	await db.insert(Repuestos).values([
		...
		{ id: "rep-backglass-iphone-17-pro-max", deviceType: "iphone", familia: "iphone-17", categoria: "backcover", modelo: "iphone-17-pro-max", precioConMensaje: null, precioSinMensaje: 240, calidad: "original", garantiaDias: 180, imageUrl: IMGS["iphone-17-pro-max"], tags: ["backcover", "tapa-trasera", "iphone"] },
