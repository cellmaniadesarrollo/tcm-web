...
export default async function seed() {
	...
	await db.insert(Repuestos).values([
		...
		{ id: "rep-pantalla-iphone-14-max", deviceType: "iphone", familia: "iphone-14", categoria: "pantalla", modelo: "iphone-14-max", precioConMensaje: 250, precioSinMensaje: 275, calidad: "original", garantiaDias: 180, imageUrl: IMGS["iphone-14-pro"], tags: ["pantalla", "iphone"] },
		...
		{ id: "rep-backglass-iphone-16-plus", deviceType: "iphone", familia: "iphone-16", categoria: "backcover", modelo: "iphone-16-plus", precioConMensaje: null, precioSinMensaje: 140, calidad: "original", garantiaDias: 180, imageUrl: IMGS["iphone-16-plus"], tags: ["backcover", "tapa-trasera", "iphone"] },
